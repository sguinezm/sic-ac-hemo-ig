...
CodeSystem: HemoTypeOfInterventionsCS
Id: HemoTypeOfInterventionsCS
...
* #1 "coronary_angiography"
* #2 "angioplasty"
* #3 "coro_ventricle"
* #4 "aortography"
* #5 "ventriculography"
* #6 "right_hearth_catheterization"
* #7 "bridge_analysis"
...
* #1 "none"
* #2 "Asthma (disorder)"
* #3 "Chronic obstructive pulmonary disease (disorder)"
